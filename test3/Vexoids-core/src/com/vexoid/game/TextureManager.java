...
public class TextureManager {
	...
	public static Texture RED_BULLET2 = new Texture(Gdx.files.internal("assets/image/red-bullet2.png"));
	
	public static Texture LASER_ENEMY = new Texture(Gdx.files.internal("assets/image/enemyship_2.png"));
	public static Texture LASER_WARNING1 = new Texture(Gdx.files.internal("assets/image/laser-indicator1.png"));
	public static Texture LASER_WARNING2 = new Texture(Gdx.files.internal("assets/image/laser-indicator2.png"));
	...
	public static Texture LASER_BULLET3 = new Texture(Gdx.files.internal("assets/image/laser4.png"));
	public static Texture LASER_BULLET4 = new Texture(Gdx.files.internal("assets/image/laser5.png"));
